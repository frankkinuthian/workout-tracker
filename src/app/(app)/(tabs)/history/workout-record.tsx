...
export default function WorkoutRecord() {
  ...
  const getTotalVolume = () => {
          ...
          exercise.sets?.reduce((setAcc, set) => {
            if (set.weight && set.reps) {
              return {
                ...
                unit: set.weightUnit || setAcc.unit,
              };
            }
            return setAcc;
          }, acc) || acc
    ...
    return result || { volume: 0, unit: "kgs" };
  };
      ...
      <ScrollView className="flex-1">
        ...
        <View className="bg-white p-6 border-b border-gray-300">
          <View className="flex-row items-center justify-between mb-4">
            <Text className="text-lg font-semibold text-gray-9">
              Workout Summary
            </Text>
            <TouchableOpacity
                  ...
                  <View className="flex-row items-center justify-between">
                    ...
                    <Text className="text-sm font-medium text-gray-600">
                      {exerciseData.sets
                        ...
                        .toLocaleString()}
                      {""}
                      {exerciseData.sets[0]?.weightUnit || "kgs"}
                    </Text>
                  </View>
                </View>
              )}
